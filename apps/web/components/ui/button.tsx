...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-semibold transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500/20 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "bg-blue-500 text-white shadow-sm shadow-blue-500/25 hover:bg-blue-600 hover:shadow-md hover:shadow-blue-500/30 active:scale-[0.98]",
        destructive:
          "bg-rose-500 text-white shadow-sm shadow-rose-500/25 hover:bg-rose-600 hover:shadow-md hover:shadow-rose-500/30 active:scale-[0.98]",
        outline:
        ...
        success:
          "bg-emerald-500 text-white shadow-sm shadow-emerald-500/25 hover:bg-emerald-600 hover:shadow-md hover:shadow-emerald-500/30 active:scale-[0.98]",
      },
      size: {
