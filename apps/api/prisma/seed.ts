...
async function main() {
  ...
  const kimWorkDates = [
    {
      date: '2026-01-02',
      content: '프로젝트 킥오프 미팅 및 요구사항 수집 계획 수립',
      hours: 8,
      progress: 5,
    },
    {
